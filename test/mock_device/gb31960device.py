...
from pydatacoll.protocols.gb31960.frame import *
...
class GB3196Device:
    def __init__(self, device_info: dict, io_loop: asyncio.AbstractEventLoop):
        ...
        self.coll_interval = datetime.timedelta(seconds=config.getint('GB31960', 'coll_interval', fallback=900))
        self.coll_count = 0
        ...
        self.log_frame = config.getboolean('GB31960', 'log_frame', fallback=True)
    ...
    async def reconnect(self):
        try:
            ...
            await self.send_frame()  # TODO send login frame
